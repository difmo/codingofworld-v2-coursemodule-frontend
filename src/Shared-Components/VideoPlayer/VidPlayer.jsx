...
export const VidPlayer = () => {
  ...
  React.useEffect(() => {
    axios
      .get(`https://codingofworldv2-coursemodule-backend.onrender.com/snapshot/get/${user._id}/${videoId}`)
  ...
  const addBookmark = () => {
    ...
    axios
      .post('https://codingofworldv2-coursemodule-backend.onrender.com/snapshot/add', obj)
