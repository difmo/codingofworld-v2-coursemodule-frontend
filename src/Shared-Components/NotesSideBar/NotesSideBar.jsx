...
export const NotesSideBar = () => {
  ...
  const getNoteFromDb = () => {
    axios
      .get(`https://codingofworldv2-coursemodule-backend.onrender.com/notes/get/${user._id}/${videoId}`)
      .then((res) => {
  ...
  const saveIntoDB = () => {
    return axios
      .put(
        `https://codingofworldv2-coursemodule-backend.onrender.com/notes/patch/${user._id}/${videoId}`,
        {
          content: newEdit,
        },
        {
